(function(){
    ...
    function initStages() {
        ...
        textStage.canvas.width = textWidth;
    ...
    function initText() {
        text = new createjs.Text("t", "80px 'Yahei'", "#ecf0f5");
    ...
    function clickscreen() {
        $("body").click(function(){
            ...
            window.setTimeout("window.location='/map'",6000);
        });
    }
    // event handlers
    ...
    function createText(t) {
        ...
        var pix = ctx.getImageData(0,0,textWidth,200).data;
        textPixels = [];
        for (var i = pix.length; i >= 0; i -= 4) {
            if (pix[i] != 0) {
                var x = (i / 4) % textWidth;
                var y = Math.floor(Math.floor(i/textWidth)/4);
